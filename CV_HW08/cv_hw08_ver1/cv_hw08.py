...
def main(Config):
	...
	open_10 = Opening(sp010, oct_Kernel)
	othc_10 = Closing(open_10, oct_Kernel)
	cv2.imwrite('opening-then-closing_sp10.bmp', othc_10)
	# salt-and-pepper noise 0.05, opening-then-closing
	open_30 = Opening(sp005, oct_Kernel)
	othc_30 = Closing(open_30, oct_Kernel)
	cv2.imwrite('opening-then-closing_sp30.bmp', othc_30)
	# salt-and-pepper noise 0.1, closing-then-opening
	clos_10 = Closing(sp010, oct_Kernel)
	ctho_10 = Opening(clos_10, oct_Kernel)
	cv2.imwrite('closing-then-opening_sp10.bmp', ctho_10)
	# salt-and-pepper noise 0.05, closing-then-opening
	clos_30 = Closing(sp005, oct_Kernel)
	ctho_30 = Opening(clos_30, oct_Kernel)
	cv2.imwrite('closing-then-opening_sp30.bmp', ctho_30)
